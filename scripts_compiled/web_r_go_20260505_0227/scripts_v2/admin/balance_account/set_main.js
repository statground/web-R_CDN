...
function Div_main(props) {
  ...
  const payment_list = Object.keys(props.data.table).map(
    (btn_data) => /* @__PURE__ */ React.createElement("div", { key: btn_data, class: "bg-white border-b w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col px-6 py-4 space-y-1 cursor-pointer hover:bg-gray-100 w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-row justify-start items-center space-x-2" }, /* @__PURE__ */ React.createElement("span", { class: "font-bold text-sm w-fit max-w-9/12 truncate ..." }, props.data.table[btn_data].product_name)), /* @__PURE__ */ React.createElement("div", { class: "flex flex-wrap justify-start items-center w-full space-x-2" }, /* @__PURE__ */ React.createElement("span", { class: class_span_btn_default + " bg-green-100 text-green-800" }, /* @__PURE__ */ React.createElement("img", { src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/board_user.svg", class: "w-3 h-3 mr-1" }), props.data.table[btn_data].username), /* @__PURE__ */ React.createElement("span", { class: class_span_btn_default + " bg-gray-100 text-gray-800" }, props.data.table[btn_data].email), /* @__PURE__ */ React.createElement("span", { class: class_span_btn_default + " bg-yellow-100 text-yellow-800" }, props.data.table[btn_data].amount.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ","), "\uC6D0"), /* @__PURE__ */ React.createElement("span", { class: class_span_btn_default + " bg-blue-100 text-blue-800" }, /* @__PURE__ */ React.createElement("img", { src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/calendar_" + Number(props.data.table[btn_data].updated_at.split("-")[2].substr(0, 2)).toString() + ".svg", class: "w-3 h-3 mr-1" }), props.data.table[btn_data].updated_at))))
  );
