...
(function() {
  ...
  window.WebRBookPages.list = async function set_main_list() {
    ...
    function Span_btn_user(props) {
      ...
      return /* @__PURE__ */ React.createElement("span", { class: `${classSpanBtnDefault} text-xs ${roleClass}` }, /* @__PURE__ */ React.createElement("img", { src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/board_user.svg", class: "w-3 h-3 mr-1" }), props.user_nickname);
    }
    function Span_btn_date(props) {
      var _a;
      return /* @__PURE__ */ React.createElement("span", { class: `${classSpanBtnDefault} text-xs bg-blue-100 text-blue-800` }, /* @__PURE__ */ React.createElement("img", { src: `https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/calendar_${Number(((_a = (props.date || "").split("-")[2]) == null ? void 0 : _a.substr(0, 2)) || "1")}.svg`, class: "w-3 h-3 mr-1" }), props.date);
    }
    function Span_btn_article_read(props) {
      return props.cnt_read > 0 ? /* @__PURE__ */ React.createElement("span", { class: `${classSpanBtnDefault} text-xs bg-gray-100 text-blue-800` }, /* @__PURE__ */ React.createElement("img", { src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/eye.svg", class: "w-3 h-3 mr-1" }), String(props.cnt_read).replace(/\B(?=(\d{3})+(?!\d))/g, ",")) : null;
    }
    function Span_btn_article_comment(props) {
      return props.cnt_comment > 0 ? /* @__PURE__ */ React.createElement("span", { class: `${classSpanBtnDefault} text-xs bg-purple-100 text-blue-800` }, /* @__PURE__ */ React.createElement("img", { src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/comment.svg", class: "w-3 h-3 mr-1" }), String(props.cnt_comment).replace(/\B(?=(\d{3})+(?!\d))/g, ",")) : null;
    }
    function Span_btn_book(props) {
      return props.title ? /* @__PURE__ */ React.createElement("span", { class: `${classSpanBtnDefault} text-xs bg-green-100 text-green-800` }, /* @__PURE__ */ React.createElement("img", { src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/book.svg", class: "w-3 h-3 mr-1" }), props.title) : null;
    }
