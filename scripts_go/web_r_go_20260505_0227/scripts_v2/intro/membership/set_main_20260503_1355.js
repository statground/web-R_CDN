const MembershipPage = /* @__PURE__ */ (() => {
  ...
  function Main() {
    return /* @__PURE__ */ React.createElement("div", { className: "mx-auto flex w-full max-w-screen-sm flex-col items-center justify-center px-20 py-8 md:px-8" }, /* @__PURE__ */ React.createElement(PageHeader, { title: "\uC815\uD68C\uC6D0 \uAC00\uC785" }), /* @__PURE__ */ React.createElement("div", { className: "grid w-full grid-cols-4 items-start justify-center gap-4 md:flex md:flex-col md:gap-0 md:space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex w-full flex-col items-center justify-center" }, /* @__PURE__ */ React.createElement(UserInfoPanel, null)), products.map((product) => /* @__PURE__ */ React.createElement(ProductCard, { key: product.uuid, product }))));
  }
  function renderMain() {
