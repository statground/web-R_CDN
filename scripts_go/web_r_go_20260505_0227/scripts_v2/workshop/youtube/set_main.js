...
function Div_new_article_list_youtube(props) {
  const publishDate = props.data.youtube_publish_date || (props.data.created_at ? String(props.data.created_at).slice(0, 10) : "");
  const viewCount = props.data.youtube_views != null ? props.data.youtube_views : props.data.cnt_read;
  return /* @__PURE__ */ React.createElement("div", { class: "bg-white border-b w-full" }, /* @__PURE__ */ React.createElement("a", { href: init_url + "read/" + props.data.uuid + "/", class: "flex flex-col px-6 py-4 space-y-2 cursor-pointer hover:bg-gray-100 w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex justify-center items-center w-full" }, /* @__PURE__ */ React.createElement("img", { src: props.data.youtube_thumbnail, alt: "YouTube Thumbnail", class: "w-full h-auto object-cover rounded-lg" })), /* @__PURE__ */ React.createElement("div", { class: "flex flex-row justify-start items-center space-x-2" }, /* @__PURE__ */ React.createElement("span", { class: "font-bold text-sm w-fit max-w-9/12 truncate ..." }, props.data.title)), /* @__PURE__ */ React.createElement("div", { class: "flex flex-row justify-start items-center space-x-2" }, /* @__PURE__ */ React.createElement(Span_btn_article_read, { cnt_read: viewCount }), /* @__PURE__ */ React.createElement(Span_btn_article_comment, { cnt_comment: props.data.cnt_comment }), /* @__PURE__ */ React.createElement(Span_btn_date, { date: publishDate }))));
}
...
function YouTubeListPage(props) {
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center py-8 px-20 w-full max-w-screen-sm mx-auto md:px-8" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: header_title, subtitle: header_subtitle }), /* @__PURE__ */ React.createElement("div", { id: "div_community_list", class: "flex flex-col justify-center items-center w-full space-y-4" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full gap-4 md:grid-cols-1" }, /* @__PURE__ */ React.createElement("div", { id: "div_article_list", class: "w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" }))), props.showWriteButton && /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      class: "text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-1/6 ml-auto md:w-full hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300"
    },
    "\uAE00\uC4F0\uAE30"
  )))));
}
...
async function get_article_list_youtube(mode_value) {
  ...
  const chunk = Object.keys(data.list || {}).map((key) => /* @__PURE__ */ React.createElement(Div_new_article_list_youtube, { key, data: data.list[key] }));
  const placeholderId = "div_article_list_" + (page_num + 1);
  if (mode_value === "init") {
    ReactDOM.render(
      /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" }), /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-3 justify-center items-start w-full gap-4 md:grid-cols-1" }, chunk, /* @__PURE__ */ React.createElement("div", { id: placeholderId, class: "w-full" }))),
      document.getElementById("div_article_list")
    );
  } else {
    ReactDOM.render(
      /* @__PURE__ */ React.createElement("div", { class: "contents" }, chunk, /* @__PURE__ */ React.createElement("div", { id: placeholderId, class: "w-full" })),
