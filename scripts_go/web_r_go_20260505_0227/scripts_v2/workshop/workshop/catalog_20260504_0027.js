const WorkshopCatalogPage = (() => {
  ...
  function WorkshopVisual({ item }) {
    ...
    ) : /* @__PURE__ */ React.createElement("div", { className: "flex h-full w-full flex-col items-center justify-center bg-gray-50 text-center" }, /* @__PURE__ */ React.createElement("img", { className: "mb-4 h-20 w-20 opacity-80", src: "https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/R_logo.svg", alt: "", loading: "lazy" }), /* @__PURE__ */ React.createElement("p", { className: "px-6 text-xl font-extrabold text-gray-900" }, "Web-R Workshop")), /* @__PURE__ */ React.createElement("div", { className: "absolute left-0 top-0 flex flex-row gap-1 p-3" }, /* @__PURE__ */ React.createElement("span", { className: "bg-blue-600 px-2 py-1 text-xs font-semibold text-white" }, statusLabel(item.status)), !item.active && /* @__PURE__ */ React.createElement("span", { className: "bg-gray-900 px-2 py-1 text-xs font-semibold text-white" }, "\uC228\uAE40")));
  }
