                ...
                <div className={cellHeaderClass}>
                  <div className="flex items-center gap-2 text-[12px]">
                    ...
                    <div className="inline-flex items-center rounded-full bg-slate-900/5 p-0.5 dark:bg-slate-800/60">
                      <button
                        type="button"
                        onClick={() => { if (!canEdit) return; setCells((prev) => prev.map((c) => (c.id === cell.id ? { ...c, mode: "r" } : c))); }}
                      ...
                      <button
                        type="button"
                        onClick={() => { if (!canEdit) return; setCells((prev) => prev.map((c) => (c.id === cell.id ? { ...c, mode: "markdown" } : c))); }}
                  ...
                  <div className="flex items-center gap-1 text-[11px]">{canEdit && (<>
                    {canEdit && cell.mode === "r" && (
                      <>
