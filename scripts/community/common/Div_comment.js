function Div_comment(props) {
    ...
    return (
        <div class="bg-white border-b w-full">
            <div class="flex flex-col px-6 py-4 space-y-2 cursor-pointer hover:bg-gray-100 w-full"
                onClick={() => location.href='/community' + article_category_url + '/read/' + props.data.uuid_article + '/'}>
